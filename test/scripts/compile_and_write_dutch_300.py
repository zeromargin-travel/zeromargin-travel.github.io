#!/usr/bin/env python3
"""
Zero-Margin Travel App - Dutch 300 Complete Importer (v33.0.0)
Imports and processes 60 spots each for Amsterdam, Rotterdam, The Hague, Utrecht, Maastricht.
"""
...
def create_spot(sid, name_en, name_ja, category, desc_ja, desc_en, tip_ja, tip_en, price_ja, lat, lng, zone="city", kids=False, rain=False, shopping=False, free=False):
    full_name = f"{name_en}（{name_ja}）" if name_ja else name_en
