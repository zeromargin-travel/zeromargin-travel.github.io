...
# 1. Update isSpotMatchingFilter for Night Scope
old_is_spot_match = re.search(r'isSpotMatchingFilter\(spot,\s*preset,\s*category,\s*conditions\)\s*\{.*?\n  \},', code, re.DOTALL)
...
# 2. Update renderCandidateSpots HTML block
...
print("🎉 Night Spots Scope expansion applied in ai-travel-engine.js successfully!")
