...
# Load all initial written chunks
for i in range(1, 11):
...
# Load the 28 fixed spots, which will overwrite the initial written ones
fixed_file = 'data/target_b_errors_fixed.json'
...
print(f"Successfully merged {updated_count} Target B spots into master_spots.json.")
