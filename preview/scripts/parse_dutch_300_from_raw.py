#!/usr/bin/env python3
"""
Zero-Margin Travel App - Dutch 300 Master Parser & Builder (v33.0.0)
Parses scripts/dutch_prompt_300_full_raw.txt and populates:
...
def run_parser():
    with open("scripts/dutch_prompt_300_full_raw.txt", "r", encoding="utf-8") as f:
        text = f.read()
